...
CREATE TABLE IF NOT EXISTS `ai_model_config` (
    ...
    `api_base_url` VARCHAR(512) DEFAULT NULL COMMENT 'OpenAI-compatible API base URL',
    `api_key` VARCHAR(1024) DEFAULT NULL COMMENT 'Encrypted or private API key',
    `temperature` DECIMAL(4,2) DEFAULT NULL COMMENT 'Default generation temperature',
    `max_tokens` INT DEFAULT NULL COMMENT 'Default max tokens',
