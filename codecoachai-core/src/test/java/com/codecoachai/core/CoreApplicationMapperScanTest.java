...
import com.codecoachai.core.CoreApplication;
...
class CoreApplicationMapperScanTest {

    @Test
    void scansMapperPackagesWithoutTreatingServiceInterfacesAsMappers() {
        MapperScans mapperScans = CoreApplication.class.getAnnotation(MapperScans.class);
