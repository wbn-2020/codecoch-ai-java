...
public class InnerCampaignArchiveSourceVO {

    public static final String SOURCE_SCHEMA_VERSION = "V8_CAMPAIGN_ARCHIVE_SOURCE_V1";

    private String sourceSchemaVersion = SOURCE_SCHEMA_VERSION;
    private Long userId;
